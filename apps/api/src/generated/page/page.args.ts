...
import { PageCreateInput } from "../page/inputs/PageCreateInput.input";
import { PageCreateManyInput } from "../page/inputs/PageCreateManyInput.input";
import { PageOrderByWithAggregationInput } from "../page/inputs/PageOrderByWithAggregationInput.input";
import { PageOrderByWithRelationInput } from "../page/inputs/PageOrderByWithRelationInput.input";
import { PageScalarWhereWithAggregatesInput } from "../page/inputs/PageScalarWhereWithAggregatesInput.input";
import { PageUpdateInput } from "../page/inputs/PageUpdateInput.input";
...
export class FindFirstPageArgs {
  ...
  distinct?: Array<"id" | "title" | "questionnaireId" | "predecessorId"> | undefined;
}
...
export class GroupByPageArgs {
  ...
  @NestJsGraphQL.Field(() => [PageOrderByWithAggregationInput], { nullable: true })
